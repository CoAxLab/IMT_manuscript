...
elseif strcmp(dir, 'limbic left')
    h = addbrain('limbic'); delete(h(6)); h(6)=[];
        view(-95, 5);

elseif strcmp(dir, 'limbic right')
    h = addbrain('limbic'); delete(h(6)); h(6)=[];
        view(95, 5);
...
if do_brainstem
    h2 = addbrain('brainstem');
    set(h2, 'FaceColor', [.5 .5 .5], 'FaceAlpha', .8);
    h = [h h2];
end
